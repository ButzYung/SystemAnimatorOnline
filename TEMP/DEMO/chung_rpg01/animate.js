...
if (MMD_SA_options.Dungeon._states.dialogue_mode)
  return
MMD_SA.SpeechBubble.message(0, "這裏妖氣很重...", 1000)
//return { returnValue:true }
  }
...
//0
 ...
 ,para: { scale:1.5 }
       ...
       ,{
          message: {
  content: "今日是茅山高校的入學試... 馬夫人要我先找到她..."
          }
        }
       ,{
          message: {
  content: "這裏是京都嗎? 怎麽會在茅山高出現? 看似有點難度呢..."
          }
        }
       ,{
          message: {
...
//0
 ...
 ,NPC: 1
  ...
  "1": { name:"NPC talk A" }
       ...
       ,{
          message: {
  content: "Sorry, 馬校長~! 這裏很難找呀~!"
          }
        }
       ,{
          message: {
  content: "馬夫人: 想不到我藏在結界裏吧. 在我的結界裏, 任誰也難為所欲為."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "馬夫人: 不要以為擁有三把上古神劍就足夠, 你要學習的還多得很呢~!"
 ,NPC: 1
          }
        }
       ,{
  ...
  content: "明白~"
       ...
       ,{
          message: {
  content: "馬夫人: 點都好, 你的第一關測試萛是成功了. 跟著是第二關測試~!"
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "馬夫人: 我在這個空間放了七個裝著「大蛇魂之碎片」的寶箱, 分別散落在不同地方."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "馬夫人: 要留意部份寶箱只出現在正或反空間, 所以你要不時使用那個留聲機來穿梭正反兩個空間."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "馬夫人: 當你找齊所有碎片再回來吧. GOGOGO~!"
 ,NPC: 1
          }
        }
       ,{
...
//1
     ,[
        {
          message: {
  content: "馬夫人: 找齊了全部「大蛇魂之碎片」了嗎? 還是想來點格鬥訓練?"
 ,NPC: 1
          }
         ,turn_to_character: 1
         ,look_at_character: 1
...
//func: function () { console.log(MMD_SA_options.Dungeon_options.options_by_area_id["start"]._saved); console.log(MMD_SA_options.Dungeon_options.options_by_area_id["sewer_0"]._saved); },
 ...
 ,_else: {
    message:{
  content: "馬夫人: 你未找齊所有「大蛇魂之碎片」啊, 再努力一點吧~!"
 ,NPC: 1
    }
   ,turn_to_character: 1
   ,look_at_character: 1
...
//4
 ...
 ,NPC: 1
  ...
  "1": { name:"NPC talk A" }
       ...
       ,{
          message: {
  content: "馬夫人: 測試暫時在此結束, 擇日會有新的考驗, 期待吧~!"
 ,NPC: 1
          }
        }
       ,{
