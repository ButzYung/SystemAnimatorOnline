...
(function () {
  ...
  self.SA_wallpaper_src = System.Gadget.path + "\\TEMP\\DEMO\\bg_miku_x_teto_c50.jpg"
...
// lava
    {
  map: System.Gadget.path + "/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_COLOR_1024x1024_AO-50.jpg"
 ,normalMap: System.Gadget.path + "/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_NRM_1024x1024.jpg"
 ,specularMap: System.Gadget.path + "/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_SPEC_1024x1024_c80.jpg"
...
//1
   ,{ character_index: 2 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 3 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 4 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 5 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 6 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 7 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 8 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index: 9 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
   ,{ character_index:10 ,use_combat_motion:true, combat_stats:{hurt_vfx:{name:"explosion_purple_01"}} }
...
return (d._parry_level_ && random(d._parry_level_+1))||0
    ...
    var npc_list = [];
    for (var i = 0, i_max = 10; i < i_max; i++) {
...
//console.log(npc_list)
 ...
 ,para: { scale:1.5 }
       ...
       ,{
          message: {
  content: "Hey Riku... what are you doing here?"
          }
        }
       ,{
          message: {
  content: "Riku: I found these interesting golems on this island. It seems they can be used as combat dummies. Wanna try? ^o^"
 ,NPC: 1
          }
        }
       ,{
  ...
  content: "......"
       ...
       ,{
          message: {
  content: "「Keyboard Basic Control:\n* Movement:WASD\n* Jump:SPACE\n* Camera change:Arrow Up\n* Camera reset:Arrow Down/Numpad 0\n* Toggle \"Look at camera\":Numpad 0」"
 ,bubble_index: 3
 ,para: { scale:1.5 }
          }
        }
 ...
 ,para: { scale:1.5 }
       ...
       ,{
          message: {
  content: "「Attack combos are combinations of different Numpad keys.\nExample:5,5,4,6\nSome attack combos required the + key pressed.\nExample:+8,5,9」"
 ,bubble_index: 3
 ,para: { scale:1.5 }
          }
        }
/*
       ,{
          message: {
  content: "Riku: As a combat training, we won't fight back. Feel free to try your attack combos~!"
 ,NPC: 1
          }
        }
*/
...
//0
      [
        {
          message: {
  content: "Riku: Do you want to change the settings?"
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "1. I want to try the Easy mode.\n2. I want to try the Hard mode.\n3. I want to see the attack combo list.\n4. Nothing. Let's continue."
 ,bubble_index: 2
 ,branch_list: [
...
//3
     ,[
        {
          message: {
  content: "Riku: You want some serious fights? As you wish~!"
 ,NPC: 1
          }
        }
       ,{
...
*/
 ...
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01.pmx"

 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone1.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone2.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone3.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone4.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone5.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone6.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone7.pmx"
 ,System.Gadget.path + "/jThree/model/golem002.zip#/golem002_x0.75_v01#clone8.pmx"
...
self.SA_wallpaper_src = "TEMP/DEMO/bg_kemurikusa01_c80.jpg"
