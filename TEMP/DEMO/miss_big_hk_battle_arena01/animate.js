...
//  model_path: System.Gadget.path + "/TEMP/DEMO/models/miss_foo.zip#/_MissFoo_v09b_for_SA-CLEANED_v01.pmx"
  model_path: System.Gadget.path + '\\TEMP\\DEMO\\models\\_Miss_HK_v01c_shirt_v05_CLEANED_v01.min.zip#\\_Miss_HK_v01c_shirt_v05_CLEANED_v01.pmx'
...
//1
   ,{ character_index: 2 ,use_combat_motion:true }
   ,{ character_index: 3 ,use_combat_motion:true }
   ,{ character_index: 4 ,use_combat_motion:true }
   ,{ character_index: 5 ,use_combat_motion:true }
   ,{ character_index: 6 ,use_combat_motion:true }
   ,{ character_index: 7 ,use_combat_motion:true }
   ,{ character_index: 8 ,use_combat_motion:true }
   ,{ character_index: 9 ,use_combat_motion:true }
   ,{ character_index:10 ,use_combat_motion:true }

//10
   ,{
//  path: "F:\\MMD\\accessories\\ハンマー\\100tハンマー.x"
  path: System.Gadget.path + "/TEMP/DEMO/models/weapon_series.zip#/狼牙棒_v00.x"
 ,placement: {
    grid_id_filter: function () {
return [
  {
    para:{
      parent_bone: { model_index:2, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:3, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:4, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:5, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:6, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
/*
 ,{
    para:{
      parent_bone: { model_index:7, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:8, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:9, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
 ,{
    para:{
      parent_bone: { model_index:10, name:"右ダミー", position:{x:0,y:0,z:0}, rotation:{x:0,y:0,z:0} }
    }
  }
*/
];
...
//   ,fog: { color:"" }
 ...
 ,inventory: {
    list:[
  { item_id:"potion_hp_50", stock:3 }
 ,{ item_id:"coin", stock:500 }
    ]
  }
...
//   ,hidden: true
 ...
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(1, {p_to_assign:p_to_assign[0], combat_action:["PC combat attack 2-handed weapon 01"]}); } }//, {combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(2, {p_to_assign:p_to_assign[1], combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(3, {p_to_assign:p_to_assign[2], combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(4, {p_to_assign:p_to_assign[3], combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(5, {p_to_assign:p_to_assign[4], combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(6, {p_to_assign:p_to_assign[5]}); } }//, combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(7, {p_to_assign:p_to_assign[6]}); } }//, combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(8, {p_to_assign:p_to_assign[7]}); } }//, combat_action:["PC combat attack 2-handed weapon 01"]}); } }
 ,{ _constructor: function () { return MMD_SA_options.Dungeon.utils.create_combat_character(9, {p_to_assign:p_to_assign[8]}); } }//, combat_action:["PC combat attack 2-handed weapon 01"]}); } }
...
//4
 ...
 ,para: { scale:1.5 }
       ...
       ,{
          message: {
  content: "注意: 手機版使用了簡易輸入模式, 基本上隨意按4-6(腳)及7-9(拳)的任意組合, 就會使出隨機招式. 頭兩個鍵的組合會影響招式類型."
 ,bubble_index: 3
 ,para: { scale:1.5 }
          }
        }
...
*/
/*
  'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員.pmx'

 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone1.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone2.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone3.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone4.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone5.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone6.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone7.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone8.pmx'
 ,'F:\\MMD\\models\\埼玉県警機動隊員ver0.90\\埼玉県警機動隊員ver0.90.zip#\\埼玉県警機動隊員#clone9.pmx'
*/

  System.Gadget.path + "/TEMP/DEMO/models/mrs_ma.min.zip#/_0Ma_v06h_for_SA_v04.pmx"

 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone1.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone2.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone3.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone4.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone5.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone6.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone7.pmx"
 ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone8.pmx"
// ,System.Gadget.path + "/TEMP/DEMO/models/goblin.zip#/goblin_v02#clone9.pmx"
