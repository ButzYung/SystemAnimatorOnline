...
//  "0": { side:2, transparent:false }
   ...
   ,"chest.x": {
      material_para: {
        "0": {
  use_normal:true, use_normal_jpg:true
 ,use_specular:true, use_specular_jpg:true
 ,use_metalness:true
        }
      }
    }
 ...
 ,onclick: [
    {
     ...
     ,is_dblclick: true
     ,events: [
  {id:"noodle_cart01", click_range:64*2}
 ,{id:"noodle_cart01", click_range:64*2}

 ,{id:"misc_store01", click_range:64*2}
 ,{id:"misc_store02", click_range:64*2}
 ,{id:"misc_store03", click_range:64*2}
 ,{id:"misc_store04", click_range:64*2}

 ,{id:"police_station01", click_range:64*2}
      ]
    }
  ]
...
//2
   ,{
  path: System.Gadget.path + "/images/_dungeon/x/SF-treasure_chest.zip#/chest_v02.x"
 ,construction: {
    receiveShadow: true
   ,castShadow: true
  }
...
/*
 ,starting_position_full: {
    grid_id: 2
   ,position: {x:-780, y:182.5, z:538+20}
   ,rotation: {x:0, y:180, z:0}
  }
*/
 ,point_light: { color:"#E0E0E0" }
...
//0
 ...
 ,para: { scale:1.5 }
  ...
  content: "What is this place...? Where am I...?"
       ...
       ,{
          message: {
  content: "(A voice far away): Hey! Over here~!"
...
//0
 ...
 ,NPC: 1
  ...
  content: "... Teto??"
       ...
       ,{
          message: {
  content: "Teto: Yeah it's me, Teto. I think we are stuck in some kind of dream world."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "What happens here? Why are we in this dream world?"
          }
        }
       ,{
          message: {
  content: "Teto: I have no idea. That's what I want to figure out as well."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "Teto: I had another vision last night. It seems we have to collect all 7 fragments of Orochi's soul in order find the exit of this place."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "Teto: Some of them can only be found on either the normal or this inverted plane. Use the jukebox to travel across two planes."
 ,NPC: 1
          }
        }
       ,{
          message: {
  content: "Teto: Good luck on finding the fragments. I will be here waiting for you~!"
 ,NPC: 1
          }
        }
       ,{
...
//1
     ,[
        {
          message: {
  content: "Teto: Have you found all the fragments? Or do you want some combat training instead?"
 ,NPC: 1
          }
         ,turn_to_character: 1
         ,look_at_character: 1
       ...
       ,{
          message: {
  content: "1. Check the status of collection.\n2. Try combat training.\n3. Leave."
 ,bubble_index: 2
 ,branch_list: [
    { key:1, branch_index:3 }
...
//func: function () { console.log(MMD_SA_options.Dungeon_options.options_by_area_id["start"]._saved); console.log(MMD_SA_options.Dungeon_options.options_by_area_id["sewer_0"]._saved); },
 ...
 ,_else: {
    message:{
  content: "Teto: You haven't found all the fragments yet."
 ,NPC: 1
    }
   ,turn_to_character: 1
   ,look_at_character: 1
...
//4
     ,[
        {
          message: {
  content: 'Teto: So you have found all the fragments~!'
 ,NPC: 1
          }
         ,turn_to_character: 1
         ,look_at_character: 1
  ...
  "1": { name:"NPC talk A" }
       ...
       ,{
          message: {
  content: "So, what are we going to do with these?"
          }
        }
       ,{
          message: {
  content: "Teto: Well, actually... I have no idea... XDDDD"
 ,NPC: 1
          }
        }
       ,{
  ...
  content: "......"
       ...
       ,{
          message: {
  content: "(This game ends here for now. Check back later for updates!)"
          }
        }
       ,{
          set_event_flag: { branch_index:1 }
...
//0
      [
        {
          message: {
  content: 'I want a bowl of Ramen right now...'
          }
        }
      ]
    ]
...
//1
     ,[
        {
          message: {
  content: "(You found a photo album of Luka~!)"
 ,bubble_index: 3
          }
        }
       ,{
...
//1
     ,[
        {
          message: {
  content: "(You found a photo album of Len dressed as Rin~!)"
 ,bubble_index: 3
          }
        }
       ,{
...
// ,fog: {}
 ...
 ,floor_material_index_default: 4
 ,wall_material_index_default: -1
 ,ceil_material_index_default: -1
...
d.sound.resume_channel("BGM")
 ...
 ,bubble_index: 1
       ...
       ,{
          message: {
  content: "Teto: This is my VR experiment. Let's try some combat practices. Don't worry. It won't hurt~! ^o^"
 ,NPC: 1
          }
        }
       ,{
 ...
 ,para: { scale:1.5 }
       ...
       ,{
          message: {
  content: "Teto: As a combat training, I won't fight back. Feel free to try your attack combos~!"
 ,NPC: 1
          }
        }
       ,{
...
//3
     ,[
        {
          message: {
  content: "Teto: You want some serious fights? As you wish~!"
 ,NPC: 1
          }
        }
       ,{
