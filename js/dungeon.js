...
user_camera.init(constraints).then(function (stream) {
  ...
  user_camera.video.src = toFileProtocol("C:\\Users\\user\\Videos\\TEMP\\AR Miku - Social Distancing.mp4")
