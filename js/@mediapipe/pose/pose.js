...
*/
    ...
    B("Promise", function(a) {
        ...
        b.race = function(f) {
            return new b(function(k, h) {
                for (var l = C(f), n = l.next(); !n.done; n = l.next())
                    d(n.value).J(k, h)
            }
            )
        }
    ...
    function Fa(a) {
        if (Ea)
            a = (Da || (Da = new TextEncoder)).encode(a);
        else {
            var b = void 0;
            b = void 0 === b ? !1 : b;
    ...
    Na.prototype.toJSON = function() {
        if (null == this.g)
            ...
            a = this.g,
            a = this.g = null == a || "string" === typeof a ? a : La && a instanceof Uint8Array ? Ha(a) : null;
        return a
    }
    ;
    ...
    function O(a) {
        a.g > a.i && (a.j = !0,
        K(Error("Tried to read past the end of the data " + a.g + " > " + a.i)))
    }
    function P(a) {
        var b = a.h
          , c = b[a.g]
    ...
    function Xa(a) {
        ...
        case 3:
            ...
            do {
                ...
                if (4 == a.h) {
                    a.i != b && (a.j = !0,
                    K(Error("Unmatched end-group tag")));
                    break
                }
                Xa(a)
            } while (1);
    ...
    function Ya(a, b, c) {
        a.N || (a = Pa(a.g.h, c, a.g.g),
        (c = b.m) ? c.push(a) : b.m = [a])
    }
    var Za = [];
    function $a() {
        this.h = [];
    ...
    ;function jb(a, b) {
        if (null != a)
            return Array.isArray(a) || hb(a) ? kb(a, b) : b(a)
    }
    function kb(a, b) {
        if (Array.isArray(a)) {
    ...
    function T(a, b, c) {
        ...
        a: {
            ...
            this.h = null) : this.l = Number.MAX_VALUE
        }
        if (c)
            for (b = 0; b < c.length; b++)
                a = c[b],
                a < this.l ? (a += this.j,
                (d = this.g[a]) ? fb(d) : this.g[a] = mb) : (nb(this),
                (d = this.h[a]) ? fb(d) : this.h[a] = mb)
    }
    ...
    function ob(a, b, c) {
        ...
        null == e && (e = mb);
        e === mb ? (e = fb([]),
        V(a, b, e, d)) : c && Array.isArray(e) && eb(e) & 2 && (e = e.slice(),
        V(a, b, e, d));
        return e
    }
    function W(a, b, c) {
    ...
    function pb(a, b, c) {
        ...
        if (!d) {
            var e = ob(a, c, !1);
            d = [];
            for (var g = Array.isArray(e) ? !!(eb(e) & 2) : !1, f = 0; f < e.length; f++)
                d[f] = new b(e[f]),
                g && gb(d[f].g);
            g && (gb(d),
            Object.freeze(d));
    ...
    function Y(a, b, c) {
        ...
        if (null != b) {
            ...
            d = (c = 0 > d ? 1 : 0) ? -d : d;
            0 === d ? 0 < 1 / d ? M = N = 0 : (N = 0,
            M = 2147483648) : isNaN(d) ? (N = 0,
            M = 2147483647) : 3.4028234663852886E38 < d ? (N = 0,
            M = (c << 31 | 2139095040) >>> 0) : 1.1754943508222875E-38 > d ? (d = Math.round(d / Math.pow(2, -149)),
            N = 0,
            M = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2),
            d *= Math.pow(2, -b),
    ...
    function Ab(a, b, c) {
        ...
        var g;
        if (Ca)
            (g = Ba) || (g = Ba = new TextDecoder("utf-8",{
                fatal: !1
            })),
    ...
    function Bb(a, b, c, d, e) {
        ...
        e = h - a.g.g;
        if (0 !== e)
            throw Error("Message parsing ended unexpectedly. Expected to read " + (k + " bytes, instead read " + (k - e) + " bytes, either the data ended unexpectedly or the message misreported its own length"));
        a.g.g = h;
        a.g.i = f;
        qb(b, c, g, d, void 0);
        return !0
    ...
    function hc() {
        return H(function(a) {
            ...
            case 1:
                return a.m = 2,
                F(a, WebAssembly.instantiate(dc), 4);
            case 4:
                a.g = 3;
                a.m = 0;
                break;
    ...
    function jc(a) {
        ...
        return H(function(p) {
            ...
            case 2:
                c = p.h;
                if ("object" === typeof window)
                    return fc("createMediapipeSolutionsWasm", {
                    ...
                    n = function() {
                        return H(function(m) {
                            a.g.graph && a.g.graph.url ? m = F(m, kc(a, a.g.graph.url), 0) : (m.g = 0,
                            m = void 0);
                            return m
                        })
                    }(),
...
// AT: ignore execution error for non-executable files (eg. tflite)
try{
//if (!/\.tflite$/.test(ea(h)))
...
// AT: hack for worker
                                ...
                                for (w = 0; w < m.length; ++w) {
                                    ...
                                    if (t.M)
                                        for (v = 0; v < t.M.length; ++v)
                                            A = q.data,
                                            I = A.addClassification,
                                            D = w,
                                            u = t.M[v],
                                            z = new Cb,
                                            V(z, 2, u.X),
                                            u.index && V(z, 1, u.index),
                                            u.label && V(z, 3, u.label),
                                            u.displayName && V(z, 4, u.displayName),
                                            u = wb(z, Eb),
                                            I.call(A, D, u)
                                }
                                q = q.data;
    ...
    function pc(a, b, c) {
        ...
        return H(function(e) {
            ...
            d || (d = new $b(a.h,a.D),
            a.s[b] = d),
            e.return(ac(d, c, a.G))) : e.return(void 0)
        })
    }
    function mc(a, b) {
    ...
    function rc(a) {
        ...
        this.g = new ic({
            ...
            listeners: [{
                wants: ["pose_landmarks", "world_landmarks", "segmentation_mask", "image_transformed"],
                outs: {
                    image: {
                        type: "texture",
