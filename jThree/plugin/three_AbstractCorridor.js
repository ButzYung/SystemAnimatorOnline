...
"    ",
"    \/\/ Camera Setup.",
"    vec3 lookAt = vec3(0.0, 0.0, iGlobalTime*5. *SPEED);  \/\/ \"Look At\" position.",
...
"        sceneCol = getGrey(texCol)*((diff+diff2)*0.75 *ST_opacity + ambience*0.25) + ((spec+spec2)*texCol*2. + fre*crv*texCol.zyx*2.)  *ST_opacity;",
...
"}",
		...
		"void main() {",
MMD_SA.MME_PPE_main("AbstractCorridor"),
		"}"

	].join( "\n" ),

	_refreshUniforms: function (refresh_all_uniforms) {
MMD_SA.MME_PPE_refreshUniforms.call(this, "AbstractCorridor", refresh_all_uniforms, { ST_opacity:{} })
//e.uniforms[ 'ST_opacity' ].value = (MMD_SA.music_mode) ? 0.25 + EC.effects_by_name.AbstractCorridor._EV_usage_PROCESS(beat, 0.2) * 0.75 : 1
	},
