...
// AT: path
import {Pass as $5Whe3$Pass} from "./Pass.js";
// AT: not using postprocessing
//import {Pass as $5Whe3$Pass1} from "postprocessing";




class $e4ca8dcb0218f846$var$FullScreenTriangleGeometry extends $5Whe3$BufferGeometry {
    boundingSphere = new $5Whe3$Sphere();
    constructor(){
        super();
        this.setAttribute("position", new $5Whe3$BufferAttribute(new Float32Array([
            -1,
            -1,
            3,
            -1,
        ...
        this.setAttribute("uv", new $5Whe3$BufferAttribute(new Float32Array([
            0,
            0,
            2,
            0,
...
const $e4ca8dcb0218f846$var$_camera = /* @__PURE__ */ new $5Whe3$OrthographicCamera();
...
const $12b21d24d1192a04$export$a815acccbd2c9a49 = {
    uniforms: {
        ...
        "color": {
            value: /* @__PURE__ */ new $5Whe3$Vector3(0, 0, 0)
        },
        "blueNoise": {
            value: null
        },
...
// AT: AO mask
uniform sampler2D AO_mask_diffuse;
...
// AT: AO mask
vec4 AO_mask = texture2D(AO_mask_diffuse, vUv);
float _finalAo = finalAo;
vec3 finalAo_v3 = _finalAo + (1.0-_finalAo) * AO_mask.rgb * mix(vec3(1.0), sceneTexel.rgb, float(colorMultiply));

        if (renderMode == 0.0) {
// AT: transparency
gl_FragColor = vec4( sceneTexel.rgb *finalAo_v3, sceneTexel.a);
            ...
            set: (target, propName, value)=>{
                ...
                if (propName === "stencil" && oldProp !== value) {
                    /*  this.beautyRenderTarget.stencilBuffer = value;
                      this._AO_mask.depthTexture.format = value ? THREE.DepthStencilFormat : THREE.DepthFormat;
                      this._AO_mask.depthTexture.type = value ? THREE.UnsignedInt248Type : THREE.UnsignedIntType;
                      this._AO_mask.depthTexture.needsUpdate = true;
                    ...
                    this._AO_mask.depthTexture = new $5Whe3$DepthTexture(this.width, this.height, value ? $5Whe3$UnsignedInt248Type : $5Whe3$UnsignedIntType);
                    this._AO_mask.depthTexture.format = value ? $5Whe3$DepthStencilFormat : $5Whe3$DepthFormat;
                }
                return true;
            }
        });
...
// AT: not using transparencyAware/autoDetectTransparency
//        this.autoDetectTransparency = true;
        ...
        this.beautyRenderTarget = new $5Whe3$WebGLRenderTarget(this.width, this.height, {
            ...
            format: $5Whe3$RGBAFormat,
            stencilBuffer: false
// AT: use MSAA without depthTexture
,samples:4
        });
// AT: Replace all .beautyRenderTarget[dot]depthTexture references with ._AO_mask.depthTexture
...
// AT: AO mask with depthTexture
this._AO_mask = new $5Whe3$WebGLRenderTarget(this.width, this.height, {
  minFilter: $5Whe3$LinearFilter,
  magFilter: $5Whe3$LinearFilter,
});
this._AO_mask.depthTexture = new $5Whe3$DepthTexture(this.width, this.height, $5Whe3$UnsignedIntType);
this._AO_mask.depthTexture.format = $5Whe3$DepthFormat;
this._AO_mask_layers = new THREEX.Layers();
this._AO_mask_layers.set( MMD_SA.THREEX.PPE.N8AO.AO_MASK );
this._AO_disabled_layers = new THREEX.Layers();
this._AO_disabled_layers.set( MMD_SA.THREEX.PPE.N8AO.NO_AO );

this._color_base_material  = [];
this._white_material = [];
this._color_vrm_material = [];
for (let side = 0; side <= 2; side++) {
  this._color_base_material[side]  = new THREEX.MeshBasicMaterial( { color:'black', side:side } );
  this._white_material[side] = new THREEX.MeshBasicMaterial( { color:'white', side:side } );
  this._color_vrm_material[side] = new THREEX.MeshBasicMaterial( { color:'white', side:side } );
}
this._materials = {};
        ...
        /** @type {THREE.DataTexture} */ this.bluenoise = new $5Whe3$DataTexture((0, $06269ad78f3c5fdf$export$2e2bcd8739ae039), 128, 128);
...
// AT: workaround to fix depthBufferType not found error
//            if (depthBufferType === $05f6997e4b65da14$export$ed4ee5d1e55474a5.Reverse) e.fragmentShader = "#define REVERSEDEPTH\n" + e.fragmentShader;
    ...
    renderTransparency(renderer) {
        ...
        this.depthCopyPass.material.uniforms.depthTexture.value = this._AO_mask.depthTexture;
...
// AT: AO mask
this._AO_mask.setSize(width, height);
    }
    firstFrame() {
...
this.scene.traverse(obj=>{
  if (obj.isMesh || obj.isSprite) {
    const side = obj.material.side || 0;
    this._materials[ obj.uuid ] = obj.material;
    if (this._AO_mask_layers.test( obj.layers ) === true ) {
      obj.material = this._color_vrm_material[side];
    }
    else if (this._AO_disabled_layers.test( obj.layers ) === true ) {
      obj.material = this._white_material[side];
    }
    else {
      obj.material = this._color_base_material[side];
    }
  }
});

renderer.setRenderTarget(this._AO_mask);
renderer.render(this.scene, this.camera);
...
this.effectCompositerQuad.material.uniforms['AO_mask_diffuse'].value = this._AO_mask.texture;
        ...
        if (this.frame < 1024 / this.configuration.aoSamples) {
            ...
            this.effectShaderQuad.material.uniforms["sceneDepth"].value = this.configuration.halfRes ? this.depthDownsampleTarget.textures[0] : this._AO_mask.depthTexture;
            ...
            for(let i = 0; i < this.configuration.denoiseIterations; i++){
                ...
                this.poissonBlurQuad.material.uniforms["sceneDepth"].value = this.configuration.halfRes ? this.depthDownsampleTarget.textures[0] : this._AO_mask.depthTexture;
        ...
        this.effectCompositerQuad.material.uniforms["sceneDepth"].value = this._AO_mask.depthTexture;
        ...
        this.effectCompositerQuad.material.uniforms["downsampledDepth"].value = this.configuration.halfRes ? this.depthDownsampleTarget.textures[0] : this._AO_mask.depthTexture;
...
// AT: not using postprocessing
export {$05f6997e4b65da14$export$ed4ee5d1e55474a5 as DepthType, $05f6997e4b65da14$export$2d57db20b5eb5e0a as N8AOPass};//, $87431ee93b037844$export$2489f9981ab0fa82 as N8AOPostPass};
