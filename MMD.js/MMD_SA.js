 ...
 ,WebXR: (function () {
    ...
    window.addEventListener("MMDStarted", function () {
      ...
      if (AR_options && AR_options.dom_overlay) {
        AR_options.dom_overlay.root = document.getElementById("Lgimage_BG")//(AR_options.dom_overlay.root && document.getElementById(AR_options.dom_overlay.root)) || document.body;
      }
    });
